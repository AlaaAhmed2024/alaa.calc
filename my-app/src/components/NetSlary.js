...
if(calulationInputs.job=="2"){
  ...
  show = false
    ...
    return(
        ...
        <div className="flex net-salary" style={{marginTop:"22px"}} onClick={handelDivClick}>
          
            <form className="flex-dir" id="loan-form" onSubmit={(event)=>{event.preventDefault()}}>
              <div style={{width:"100%" , direction:"rtl"}}>
              <div style={{margin:"10px" , textAlign:"center", fontWeight:"bold" , color:"black"}}>حساب الراتب الصافي</div>
